...
import r from "path";
import { URL as i, fileURLToPath as a } from "url";
import o from "net";
import s from "dns";
import c from "http";
import l from "https";
...
var p = Object.create, m = Object.defineProperty, h = Object.getOwnPropertyDescriptor, g = Object.getOwnPropertyNames, _ = Object.getPrototypeOf, v = Object.prototype.hasOwnProperty, y = (e, t) => () => (e && (t = e(e = 0)), t), b = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), x = (e, t) => {
	...
	return e;
}, ee = (e, t, n) => (n = e == null ? {} : p(_(e)), S(t || !e || !e.__esModule ? m(n, "default", {
	value: e,
	enumerable: !0
}) : n, e)), C = (e) => v.call(e, "module.exports") ? e["module.exports"] : S(m({}, "__esModule", { value: !0 }), e), w = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.");
}), T = b(((e, t) => {
	var n = w("buffer"), r = n.Buffer, i = {}, a;
	...
	function r(e, t) {
		this.enc = e.encodingName, this.bomAware = e.bomAware, this.enc === "base64" ? this.encoder = s : this.enc === "utf8" ? this.encoder = u : this.enc === "cesu8" && (this.enc = "utf8", this.encoder = c, n.from("eda0bdedb2a9", "hex").toString() !== "💩" && (this.decoder = l, this.defaultCharUnicode = t.defaultCharUnicode));
	}
	r.prototype.encoder = o, r.prototype.decoder = a;
	var i = w("string_decoder").StringDecoder;
	function a(e, t) {
	...
	u.prototype.write = function(e) {
		...
		if (this.highSurrogate) {
			...
			return this.highSurrogate = "", n.from(e, this.enc);
		}
	};
})), re = b(((e) => {
	var t = T().Buffer;
	...
	t.exports = {
		...
		cp936: {
			type: "_dbcs",
			table: function() {
				return P(), C(M).default;
			}
		},
		gbk: {
			type: "_dbcs",
			table: function() {
				return (P(), C(M).default).concat((L(), C(F).default));
			}
		},
		xgbk: "gbk",
		isoir58: "gbk",
		...
		big5hkscs: {
			type: "_dbcs",
			table: function() {
				return (K(), C(W).default).concat((me(), C(pe).default));
			},
			encodeSkipVals: [
				36457,
				36463,
	...
	t.exports = function(e) {
		...
		r.prototype = Object.create(t.prototype, { constructor: { value: r } }), r.prototype._transform = function(e, t, n) {
			if (typeof e != "string") return n(Error("Iconv encoding stream needs strings as its input."));
			try {
		...
		return i.prototype = Object.create(t.prototype, { constructor: { value: i } }), i.prototype._transform = function(e, t, r) {
			if (!n.isBuffer(e) && !(e instanceof Uint8Array)) return r(Error("Iconv decoding stream needs buffers as its input."));
			try {
	...
	var n = T().Buffer, r = te(), i = E();
	t.exports.encodings = null, t.exports.defaultCharUnicode = "�", t.exports.defaultCharSingleByte = "?", t.exports.encode = function(e, r, i) {
		e = "" + (e || "");
		var a = t.exports.getEncoder(r, i), o = a.write(e), s = a.end();
		return s && s.length > 0 ? n.concat([o, s]) : o;
	}, t.exports.decode = function(e, r, i) {
		typeof e == "string" && (t.exports.skipDecodeWarning || (console.error("Iconv-lite warning: decode()-ing strings is deprecated. Refer to https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding"), t.exports.skipDecodeWarning = !0), e = n.from("" + (e || ""), "binary"));
		var a = t.exports.getDecoder(r, i), o = a.write(e), s = a.end();
		return s ? o + s : o;
		...
		if (!t.exports.encodings) {
			var n = ge();
			t.exports.encodings = { __proto__: null }, i(t.exports.encodings, n);
		}
		for (var r = t.exports._canonicalizeEncoding(e), a = {};;) {
			var o = t.exports._codecDataCache[r];
			if (o) return o;
			var s = t.exports.encodings[r];
			switch (typeof s) {
				case "string":
					r = s;
					break;
				case "object":
					...
					a.encodingName ||= r, r = s.type;
					break;
				case "function": return a.encodingName ||= r, o = new s(a, t.exports), t.exports._codecDataCache[a.encodingName] = o, o;
	...
	}, t.exports.getEncoder = function(e, n) {
		var i = t.exports.getCodec(e), a = new i.encoder(n, i);
		return i.bomAware && n && n.addBOM && (a = new r.PrependBOM(a, n)), a;
	}, t.exports.getDecoder = function(e, n) {
		var i = t.exports.getCodec(e), a = new i.decoder(n, i);
		return i.bomAware && !(n && n.stripBOM === !1) && (a = new r.StripBOM(a, n)), a;
	}, t.exports.enableStreamingAPI = function(e) {
		if (!t.exports.supportsStreams) {
			var n = _e()(e);
			t.exports.IconvLiteEncoderStream = n.IconvLiteEncoderStream, t.exports.IconvLiteDecoderStream = n.IconvLiteDecoderStream, t.exports.encodeStream = function(e, n) {
				return new t.exports.IconvLiteEncoderStream(t.exports.getEncoder(e, n), n);
			}, t.exports.decodeStream = function(e, n) {
				return new t.exports.IconvLiteDecoderStream(t.exports.getDecoder(e, n), n);
	...
	a && a.Transform ? t.exports.enableStreamingAPI(a) : t.exports.encodeStream = t.exports.decodeStream = function() {
		throw Error("iconv-lite Streaming API is not enabled. Use iconv.enableStreamingAPI(require('stream')); to enable it.");
	};
}))(), 1), Y = d(f), ve = a(import.meta.url), X = r.dirname(ve);
t.setName("王中王工具箱");
var Z = null;
function Q() {
	Z = new e({
		...
		frame: !1,
		title: "王中王工具箱",
		icon: r.join(X, "../public/icon.png"),
		webPreferences: {
			preload: r.join(X, "preload.js"),
			nodeIntegration: !1,
			contextIsolation: !0
		}
	}), process.env.VITE_DEV_SERVER_URL ? Z.loadURL(process.env.VITE_DEV_SERVER_URL) : Z.loadFile(r.join(X, "../dist/index.html")), Z.setMenu(null), Z.on("maximize", () => {
		Z && !Z.isDestroyed() && Z.webContents.send("window-maximized");
	}), Z.on("unmaximize", () => {
		Z && !Z.isDestroyed() && Z.webContents.send("window-unmaximized");
	}), Z.on("closed", () => {
		Z = null;
	});
}
n.on("window-minimize", (t) => {
	...
	n && n.minimize();
}), n.on("window-maximize", (t) => {
	let n = e.fromWebContents(t.sender);
	n && (n.isMaximized() ? n.unmaximize() : n.maximize());
}), n.on("window-close", (t) => {
	let n = e.fromWebContents(t.sender);
	n && n.destroy();
}), n.handle("window-is-maximized", (t) => {
	let n = e.fromWebContents(t.sender);
	return n ? n.isMaximized() : !1;
});
function ye(e, t, n = 3e3) {
	return new Promise((r) => {
		let i = new o.Socket(), a = !1;
		i.setTimeout(n), i.on("connect", () => {
			a = !0, i.destroy();
		}), i.on("timeout", () => {
			i.destroy();
		}), i.on("error", () => {
...
n.handle("scan-ports", async (e, { host: t, ports: n }) => {
	let r = [], i = n.length;
	for (let a = 0; a < n.length; a++) {
		let o = n[a], s = Date.now(), c = await ye(t, o.port), l = Date.now() - s;
		r.push({
			...o,
			status: c ? "open" : "closed",
			responseTime: c ? l : "-"
		}), e.sender.send("scan-progress", {
			current: a + 1,
			total: i,
			percent: Math.round((a + 1) / i * 100)
		}), await new Promise((e) => setTimeout(e, 50));
	}
	return r;
}), n.handle("dns-query", async (e, { domain: t, type: n }) => {
	let r = Date.now();
	try {
		let e = [];
		if (n === "A") {
			let { address: n } = await s.promises.lookup(t, { family: 4 });
			e = [{
				type: "A",
				data: n,
				ttl: 300
			...
			let { address: n } = await s.promises.lookup(t, { family: 6 });
			e = [{
				type: "AAAA",
				data: n,
				ttl: 300
			...
			switch (n) {
				case "MX":
					r = await s.promises.resolveMx(t), e = r.map((e) => ({
						type: "MX",
						data: `${e.priority} ${e.exchange}`,
						ttl: 300
					}));
					break;
				case "NS":
					r = await s.promises.resolveNs(t), e = r.map((e) => ({
						type: "NS",
						data: e,
						ttl: 300
					}));
					break;
				case "CNAME":
					r = await s.promises.resolveCname(t), e = r.map((e) => ({
						type: "CNAME",
						data: e,
						ttl: 300
					}));
					break;
				case "TXT":
					r = await s.promises.resolveTxt(t), e = r.map((e) => ({
						type: "TXT",
						data: e.join(" "),
						ttl: 300
					}));
					break;
				case "SOA":
					let i = await s.promises.resolveSoa(t);
					e = [{
						type: "SOA",
						data: `${i.nsname} ${i.hostmaster} ${i.serial}`,
						ttl: i.refresh
					}];
					break;
				default: try {
					r = await s.promises.resolve(t, n), e = r.map((e) => ({
						type: n,
						data: String(e),
						ttl: 300
					}));
					...
					if (n === "ANY" || n === "A") {
						let { address: n } = await s.promises.lookup(t);
						e = [{
							type: "A",
							data: n,
							ttl: 300
		...
		let i = Date.now() - r, a = e.message;
		return e.code === "ENOTFOUND" ? a = "域名不存在或无法解析" : e.code === "ECONNREFUSED" ? a = "DNS 服务器连接被拒绝" : e.code === "ETIMEDOUT" || e.code === "ETIMEOUT" ? a = "DNS 查询超时" : e.code === "EAI_AGAIN" && (a = "DNS 服务暂时不可用，请稍后重试"), {
			success: !1,
			domain: t,
			type: n,
			error: a,
...
}), n.handle("ping", async (e, { host: t, count: n, timeout: r }) => {
	let i = process.platform === "win32", a = Math.min(Math.max(n || 4, 1), 10), o = Math.min(Math.max(r || 8e3, 1e3), 3e4);
	try {
		let e;
		e = i ? `ping -n ${a} -w ${o} ${t}` : `ping -c ${a} -W ${Math.ceil(o / 1e3)} ${t}`;
		let { stdout: n, stderr: r } = await Y(e, {
			timeout: o * a + 1e4,
			maxBuffer: 1024 * 1024,
			windowsHide: !0,
			encoding: "buffer"
		}), s;
		return s = i ? J.default.decode(n || r, "gbk") : (n || r).toString(), {
			success: !0,
			output: s,
			isWindows: i,
			host: t,
		...
		let n = "";
		return n = i ? J.default.decode(e.stdout || e.stderr || Buffer.from(""), "gbk") : (e.stdout || e.stderr || "").toString(), n.includes("请求找不到主机") || n.includes("could not find host") || n.includes("Name or service not known") || n.includes("non-existent domain") ? {
			success: !1,
			error: "无法解析主机名，请检查地址是否正确",
			isWindows: i,
			host: t,
			output: n
		} : n.includes("无法访问目标主机") || n.includes("Destination Host Unreachable") || n.includes("Network is unreachable") ? {
			success: !1,
...
function $(e, t, n = 1e4) {
	return new Promise((r, i) => {
		let a = new o.Socket(), s = "";
		a.setTimeout(n), a.on("connect", () => {
			a.write(t + "\r\n");
		}), a.on("data", (e) => {
			s += e.toString();
		}), a.on("close", () => {
			...
			a.destroy(), i(Error("Whois 查询超时"));
		}), a.on("error", (e) => {
			i(e);
		}), a.connect(43, e);
	});
}
n.handle("whois", async (e, { domain: t }) => {
	try {
		let e = be[t.split(".").pop().toLowerCase()] || "whois.iana.org", n = await $(e, t), r = n.match(/refer:\s*([^\s]+)/i);
		if (r && r[1]) {
			let i = r[1].trim();
			if (i !== e) try {
				n = await $(i, t);
		...
		return {
			success: !1,
			error: e.message || "Whois 查询失败",
			domain: t
		};
	}
});
function xe(e, t = "GET", n = 1e4) {
	return new Promise((r, a) => {
		let o = Date.now(), u = 0, d = 0;
		try {
			let f = new i(e), p = f.protocol === "https:", m = p ? l : c, h = Date.now();
			s.lookup(f.hostname, (i, s, c) => {
				if (u = Date.now() - h, i) {
					a(Error(`DNS 查询失败: ${i.message}`));
					return;
				}
				let l = {
					hostname: f.hostname,
					port: f.port || (p ? 443 : 80),
					...
					t.on("data", (e) => {
						...
						r({
							...
							headers: t.headers,
							body: i.substring(0, 1024),
							contentLength: parseInt(t.headers["content-length"]) || i.length,
							contentType: t.headers["content-type"],
							server: t.headers.server,
							url: e,
							dnsTime: u,
							connectTime: d,
							totalTime: n,
							redirected: t.socket?.encrypted || !1,
							redirectCount: 0,
							redirectUrls: []
						});
					});
				...
				_.on("error", (e) => {
					a(Error(`HTTP 请求失败: ${e.message}`));
				}), _.on("timeout", () => {
					_.destroy(), a(Error("HTTP 请求超时"));
				}), _.end();
			});
		} catch (e) {
			a(Error(`URL 解析失败: ${e.message}`));
		}
	});
}
n.handle("http-check", async (e, { url: t, method: n }) => {
	try {
		return {
			success: !0,
			data: await xe(t, n || "GET", 1e4)
		};
	} catch (e) {
		return {
			success: !1,
			error: e.message || "HTTP 检查失败"
		};
	}
}), n.handle("compute-hash", async (e, { text: t, algorithm: n }) => {
	try {
		return {
			success: !0,
			hash: u.createHash(n).update(t, "utf8").digest("hex"),
			algorithm: n
		};
	} catch (e) {
		return {
			success: !1,
			error: e.message || "哈希生成失败"
		};
	}
}), t.whenReady().then(() => {
	Q(), t.on("activate", function() {
