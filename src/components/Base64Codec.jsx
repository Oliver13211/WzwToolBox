    ...
    <div className="base64-codec">
      ...
      <div className="input-section">
        <div className="section-header">
          <label>{mode === 'encode' ? '原文' : 'Base64 文本'}</label>
        ...
        <textarea
          ...
          placeholder={mode === 'encode' ? '请输入需要编码的文本...' : '请输入需要解码的 Base64 文本...'}
          value={input}
        ...
        <div className="info-content">
          <div className="info-item">
            ...
            <div className="info-text">
              ...
              <span className="info-desc">将文本转换为 Base64 格式，常用于 URL、Email 等场景</span>
            </div>
          </div>
          <div className="info-item">
            <div className="info-icon">
            ...
            <div className="info-text">
              ...
              <span className="info-desc">将 Base64 格式还原为原始文本</span>
            </div>
          </div>
        </div>
      </div>
